export default {
	...
	template: `<div>
  	<form action="success" class="needs-validation" method="post">
						...
						<div class="form-group">
							<label for="iva">Partita IVA o Codice fiscale</label>
							<input required type="text" id="iva" name="iva" class="form-control">
						</div>
    
            <div class="form-group">
            <label  for="inputGroupSelect01">Tipo di cliente</label>
            <select class="custom-select" id="inputGroupSelect01">
            <option selected>Tipo di cliente...</option>
...
<p class="mt-5">
  <button  class="btn-primary px-4 py-2 btn-outline-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
   Cambia email
  </button>&nbsp;&nbsp;
  <button  class="btn-primary px-4 py-2 btn-outline-primary" type="button" data-toggle="collapse" data-target="#collapseExampleDue" aria-expanded="false" aria-controls="collapseExample">
   Cambia password
  </button>
</p>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
				...
				<div class="form-group">
							<label for="emal-reset">Nuova Email</label>
							<input required type="email" id="emal-reset" name="emal-reset" class="form-control">
					</div>

					<div class="form-group">
							<label for="pass-reset">Password attuale</label>
							<input required type="password" id="pass-reset" name="pass-reset" class="form-control">
					</div> 
  </div>
</div>

<div class="mt-4 collapse" id="collapseExampleDue">
  <div class="card card-body">
  ...
  <div class="form-group">
      ...
      <input required type="password" id="pass-reset" name="pass-reset" class="form-control">
			...
			<div class="form-group">
							<label for="validationPassword">Nuova password</label>

		 <input required type="password" id="validationPassword" minlength="8" name="password" placeholder="Password" value="" required class="form-control">
    ...
    <div id="progressbar" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 10%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">      
			...
			<div class="form-group mt-2">
				 <label for="pass-confirm">Conferma nuova password</label>
				 <input required type="password" id="pass-confirm" name="pass-confirm" class="form-control">   
    </div>
  ...
  <button  type="submit" class="btn-primary px-4 py-2 btn-outline-primary mt-3" >
   Salva
  </button>				
  </form>
				...
				function () {
					...
					var validation = Array.prototype.filter.call(forms, function (form) {
						...
						form.validationPassword.addEventListener("keyup", function () {
							...
							for (var i = 0; i < matchedCase.length; i++) {
								if (
									new RegExp(matchedCase[i]).test(form.validationPassword.value)
								) {
									if (i == 0)
										messageCase.splice(
